...
const CreateOrder = ({
  ...
  const onSubmit = (e) => {
    ...
    console.log("Add Order Submit data", submitData);
    // return;
  ...
  React.useEffect(() => {
    console.log("serviceCatsList", serviceCatsList);
  }, [serviceCatsList]);
  ...
  const calculateProductAmount = (orderItem, index) => {
    if (orderItem?.service_id && orderItem?.category_id) {
      ...
      console.log("serviceCatInfo", serviceCatInfo);
      console.log("orderItem", orderItem);

      if (serviceCatInfo) {
        // Convert the strings to numbers
        let num1 = orderItem.width_feet ? parseFloat(orderItem.width_feet) : 1;
        let num2 = orderItem.height_feet
          ? parseFloat(orderItem.height_feet)
          : 1;
        let num3 = orderItem.quantity ? parseFloat(orderItem.quantity) : 1;
        let num4 = parseFloat(
                          ...
                          <Col xxl="2" lg="4" md="4" xs="6">
                            <Form.Group className="form-group">
                              ...
                              <Select
                                ...
                                value={productsList.find(
                                  (b) => b.value === each[index]?.product
                                )}
                            ...
                            <Col xxl="2" lg="4" md="4" xs="6">
                              <Form.Group className="form-group">
                                ...
                                <Select
                                  ...
                                  value={productServicesList.find(
                                    (b) => b.value === each.service_id
                                  )}
                                ...
                                <Col xxl="2" lg="4" md="4" xs="6">
                                  <Form.Group className="form-group">
                                    ...
                                    <Select
                                      ...
                                      // value={each?.qualityArray.find(
                                      //   (b) => b.title === each.quality
                                      // )}
...
const mapStateToProps = (state) => ({
  ...
  productServicesList: state.productService.productServicesListAll,
  serviceCatsList: state.serviceCat.serviceCatsListAll,
});
