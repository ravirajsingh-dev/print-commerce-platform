...
// @access Private
router.get("/", [auth.Admin], getCredentialsList);

// @route GET api/user/upis/:credential_id
// @desc Get users upi by credential_id
// @access Private
router.get("/:credential_id", [auth.Admin], getCredentialsById);
...
// @access Private
router.delete("/:credential_id", auth.Admin, deleteUserCredentialById);
