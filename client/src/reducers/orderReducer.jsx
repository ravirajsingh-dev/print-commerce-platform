...
const orderSlice = createSlice({
  ...
  reducers: {
    ...
    ordersListAllUpdated(state, action) {
      return {
        ...state,
        ordersListAll: action.payload,
      };
    },
    loadingOnOrderTracking(state) {
      return {
        ...state,
        loadingOrderTracking: true,
      };
    },
    orderTrackUpdated(state, action) {
      return {
        ...state,
    ...
    orderInvoiceUpdated(state, action) {
      return {
        ...state,
